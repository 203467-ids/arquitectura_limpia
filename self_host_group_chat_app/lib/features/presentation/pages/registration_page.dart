...
class _RegistrationPageState extends State<RegistrationPage> {
      ...
      body: BlocConsumer<CredentialCubit, CredentialState>(
        listener: (context, credentialState) {
          ...
          if (credentialState is CredentialFailure) {
            snackBarNetwork(
                msg: "email equivocado por favor revisa",
          ...
          children: <Widget>[
            ...
            Container(
              child: Row(
                ...
                children: [
                  Text(
                    'Al hacer clic en registrarse, usted acepta las ',
                    style: TextStyle(
                        fontSize: 12,
                        fontWeight: FontWeight.w700,
                        color: colorC1C1C1),
                    ...
                    InkWell(
                      onTap: () {
                        setState(() {
                          _selectGender = 2;
                          _genderController.value =
                              TextEditingValue(text: "Sin especificar");
                        });
                      },
                      child: Container(
                        padding: EdgeInsets.only(
  ...
  _submitSignUp() {
    ...
    if (_passwordController.text.isEmpty) {
      toast('Agrega password');
      return;
    }
    if (_passwordAgainController.text.isEmpty) {
      toast('Agrega de nuevo password');
      return;
    }

    if (_passwordController.text == _passwordAgainController.text) {
    } else {
      toast("ambos passwords deben ser iguales");
      return;
    }
